...
Primary units are grams. Every blended ingredient quantity in grams must sum to pintFillG ±15 g (450 normal, 600 big). Servings: 3 or 4 at 150 g. After flavor powders in the mix, cut skim milk until the sum hits pintFillG. Copy the size-matching column on the macros card.
